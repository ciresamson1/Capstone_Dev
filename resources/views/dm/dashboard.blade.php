                                        ...
                                        @foreach($alertItems as $item)
                                            ...
                                            @if(isset($item['task_id']))
                                                <div class="rounded-2xl bg-white p-3 text-sm text-slate-600 shadow-sm">
                                                    <p class="font-semibold text-slate-900 truncate">{{ $taskTitle ?? 'Task update' }}</p>
                                                    <p class="mt-0.5 text-xs text-brand-500">{{ $projectName }}</p>
                                            ...
                                            @elseif($taskTitle || isset($item['details']))
                                                <div class="rounded-2xl bg-white p-3 text-sm text-slate-600 shadow-sm">
                                                    <p class="font-semibold text-slate-900">{{ $taskTitle ?? 'Update' }}</p>
                                                    <p class="mt-1">{{ $item['details'] ?? 'Task update available.' }}</p>
                                                    @if(!empty($item['time']))
